...
- Before writing any ```mermaid block, in a reply or a file, invoke the mermaid-link skill: it checks the syntax and supplies the render link the terminal can't draw.
